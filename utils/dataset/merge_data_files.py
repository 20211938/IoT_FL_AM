...
def merge_data_files(source_dir=None, output_dir=None):
    ...
    if source_dir is None:
        source_dir = project_root / 'dataset_augmented'
    if output_dir is None:
        output_dir = project_root / 'data_train'
...
if __name__ == '__main__':
    print("=" * 60)
    print("작업 1: dataset -> data_test 병합")
    print("=" * 60)
    merge_data_files(source_dir='dataset', output_dir='data_test')
    
    print("\n")
    print("=" * 60)
    print("작업 2: dataset_augmented -> data_train 병합")
    print("=" * 60)
    merge_data_files(source_dir='dataset_augmented', output_dir='data_train')
