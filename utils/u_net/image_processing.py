...
def preprocess_image(im0, im1, segmentationMask, tileSize):
    ...
    # Handle RGB images: convert to grayscale if needed
    # If image is RGB (3 channels), convert to grayscale by taking mean
    ...
    # imarray shape is now (height, width, 1) after processing above
